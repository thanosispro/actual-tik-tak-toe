...
if(board[0].innerHTML!=="" && board[1].innerHTML!=="" && board[2].innerHTML!=="" && board[3].innerHTML!=="" && board[4].innerHTML!=="" && board[5].innerHTML!=="" &&  board[6].innerHTML!=="" && board[7].innerHTML!=="" && board[8].innerHTML!==""&& document.getElementById("winner").innerHTML==""){
...
board[cells[j][i]].style.backgroundColor= "rgba(0, 0, 0, 0.8)";
board[cells[j][i+1]].style.backgroundColor= "rgba(0, 0, 0, 0.8)";
board[cells[j][i+2]].style.backgroundColor= "rgba(0, 0, 0, 0.8)";
document.getElementById("gif").innerHTML='<img src="1.gif" alt="" width="200pt">';
document.getElementById("button").innerHTML='<button class="btn" onclick="restart()">Rematch?</button>';
b=1;
}
...
function restart(){
    ...
    for(j=0;j<=8;j++){
       board[j].innerHTML="";
       board[j].style.backgroundColor="rgba(0, 0, 0, 0.1)";
    }
